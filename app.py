...
etiquetas = [
    'CHRYSOMUS ICTEROCEPHALUS', 'GYMNOMYSTAX MEXICANUS', 'HYPOPYRRHUS PYROHYPOGASTER', 
	'PARKESIA MOTACILLA', 'PARKESIA MOTACILLA_NOVEBORACENSIS', 'PARKESIA NOVEBORACENSIS', 
	'QUISCALUS LUGUBRIS', 'QUISCALUS MAJOR', 'QUISCALUS MEXICANUS', 'VERMIVORA CHRYSOPTERA'
